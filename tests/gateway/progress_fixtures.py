"""Shared gateway progress-test adapters and runner helpers."""
...
class NonEditProgressCaptureAdapter(BasePlatformAdapter):
    """Adapter that does NOT override edit_message (BlueBubbles/Signal-style)."""
...
def make_progress_runner(adapter: BasePlatformAdapter):
